...
import "./sidebar.css";
import logo from "../../assets/images/LogoHome.jpg";
    ...
    (item) =>
      ...
      item.modify ===
        props.location.pathname.substring(
          0,
          props.location.pathname.lastIndexOf("/") || item.sub === props.location.pathname.substring(0, props.location.pathname.lastIndexOf("/"))
        )
  );
